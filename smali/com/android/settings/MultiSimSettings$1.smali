...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v8, "EVENT_SET_DATA_SUBSCRIPTION_DONE"
    ...
    invoke-virtual {v6, v8}, Lcom/android/settings/MultiSimSettings;->dismissDialog(I)V
    ...
    const-string v9, "SET_DATA_SUBSCRIPTION_DONE: result = "
    ...
    const-string v9, "SET_TUNE_AWAY_DONE: mTuneAwayValue = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/settings/MultiSimSettings$1;->this$0:Lcom/android/settings/MultiSimSettings;

    # getter for: Lcom/android/settings/MultiSimSettings;->mTuneAwayValue:Z
    invoke-static {v9}, Lcom/android/settings/MultiSimSettings;->access$1100(Lcom/android/settings/MultiSimSettings;)Z
    ...
    :goto_1
    invoke-virtual {v8, v6}, Landroid/preference/CheckBoxPreference;->setSummary(Ljava/lang/CharSequence;)V

    .line 561
    iget-object v6, p0, Lcom/android/settings/MultiSimSettings$1;->this$0:Lcom/android/settings/MultiSimSettings;

    invoke-virtual {v6}, Lcom/android/settings/MultiSimSettings;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v8

    const-string v9, "tune_away"
